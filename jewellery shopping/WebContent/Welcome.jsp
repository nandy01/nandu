		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					<left>
					<img src="image/bangle19.jpg" alt="" width="400" height="300"></left>
				...
				<div class="item">
					<right>
					<img src="image/aa.gif" alt="" width="400" height="300"></right>
					<div class="carousel-caption">
						<h3>Never Give Up</h3>
						<p>Bracelets</p>
					</div>
				...
				<div class="item">
					<left>
					<img src="image/2nbt27r.gif" alt="" width="400" height="300"></left>
					<div class="carousel-caption">
						<h3>Stunning</h3>
						<p>Pearl Earrings</p>
					</div>
				...
				<div class="item">
					<right>
					<img src="image/vv.gif" alt="" width="400" height="300"></right>
					<div class="carousel-caption">
						<h3>Necklace</h3>
						<p>For Princess</p>
					</div>
